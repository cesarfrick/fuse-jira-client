sealed class jiraclient_FuseControlsRectangle_float4_CornerRadius_Property: Uno.UX.Property<float4>
{
    Fuse.Controls.Rectangle _obj;
    public jiraclient_FuseControlsRectangle_float4_CornerRadius_Property(Fuse.Controls.Rectangle obj) { _obj = obj;  }
...
sealed class jiraclient_FuseControlsShape_FuseDrawingBrush_Fill_Property: Uno.UX.Property<Fuse.Drawing.Brush>
{
    Fuse.Controls.Shape _obj;
    public jiraclient_FuseControlsShape_FuseDrawingBrush_Fill_Property(Fuse.Controls.Shape obj) { _obj = obj;  }
...
sealed class jiraclient_Card_float4_CornerRadius_Property: Uno.UX.Property<float4>
{
    Card _obj;
    public jiraclient_Card_float4_CornerRadius_Property(Card obj) { _obj = obj; obj.CornerRadiusChanged += this.OnValueChanged; }
    protected override float4 OnGet() { return _obj.CornerRadius; }
...
sealed class jiraclient_Card_FuseDrawingBrush_Fill_Property: Uno.UX.Property<Fuse.Drawing.Brush>
{
    Card _obj;
    public jiraclient_Card_FuseDrawingBrush_Fill_Property(Card obj) { _obj = obj; obj.FillChanged += this.OnValueChanged; }
    protected override Fuse.Drawing.Brush OnGet() { return _obj.Fill; }
