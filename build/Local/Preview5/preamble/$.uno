...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.4"), 12124)}, "/Users/cfrick/Documents/projects/jira-client/jira-client.unoproj", new string[] { ""})
{
